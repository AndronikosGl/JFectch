...
To run it go the `dist` directory using `cd dist` and execute `java -jar "JFetch.jar"`. Bare in mind that if it doesnt run you have to use `chmod +x JFectch.jar` to give it executable permitions
